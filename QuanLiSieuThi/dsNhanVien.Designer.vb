...
Partial Public Class dsNhanVien
    ...
    Partial Public Class NhanVienDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddNhanVienRow(ByVal maNV As String, ByVal tenNV As String, ByVal SDT As String, ByVal email As String, ByVal chucVu As String, ByVal luong As Decimal) As NhanVienRow
            Dim rowNhanVienRow As NhanVienRow = CType(Me.NewRow,NhanVienRow)
            Dim columnValuesArray() As Object = New Object() {maNV, tenNV, SDT, email, chucVu, luong}
